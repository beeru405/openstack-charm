#Neutron networking
juju deploy -n --to 0,1,2 --channel 22.09/stable ovn-central
juju deploy --to 1 --channel zed/stable --config neutron.yaml neutron-api
...
#Keystone
juju deploy --to 0 --channel zed/stable keystone
...
#RabbitMQ
juju deploy --to 2 --channel 3.9/stable rabbitmq-server

juju add-relation rabbitmq-server:amqp neutron-api:amqp
juju add-relation rabbitmq-server:amqp nova-compute:amqp

#Nova cloud controller
juju deploy --to 3 --channel zed/stable --config ncc.yaml nova-cloud-controller
...
#Placement
juju deploy --to 3 --channel zed/stable placement
...
#OpenStack dashboard
juju deploy --to 2 --channel zed/stable openstack-dashboard
...
#Glance
juju deploy --to 3 --channel zed/stable glance
...
#cinder
juju deploy --to 1 --channel zed/stable --config cinder.yaml cinder
